...
class CoinService extends ServerDBChooser
{
    ...
    private $item_coin_id = 90000000;//银币的物品ID
    ...
    public function getCondition($condition){
        ...
        if(empty($sql)) return " where a.param1 = $this->item_coin_id";
        return $sql = " where a.param1 = $this->item_coin_id and ".$sql;
    }
}
