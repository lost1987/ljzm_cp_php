 ...
 * 精力日志
 */
class JingLiDailyService extends ServerDBChooser{

    private $Jingli_id='90000006';//精力id

    function JingLiDailyService(){
        $this->jingli_record_table='fr2_record';
        $this->jingli_user_table='fr_user';
    ...
    public function getCondition($condition){
        ...
        if(empty($sql)){
            return " where a.param1 = $this->Jingli_id";
        }
        return $sql = " where a.param1 = $this->Jingli_id and ".$sql;
